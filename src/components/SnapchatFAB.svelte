...
>
  ...
  <!-- Username -->
  <span class="username" class:visible={isHovered}>
    Add @{username}
  </span>
</button>
...
<style lang="postcss">
  .snapchat-button {
    ...
    @apply h-10;
    @apply bg-yellow-400/90 hover:bg-yellow-400;
    @apply rounded-full;
    @apply pr-3;
    @apply border-none;
    @apply cursor-pointer;
    @apply transition-all duration-300;
    @apply hover:shadow-lg hover:shadow-yellow-400/20;
