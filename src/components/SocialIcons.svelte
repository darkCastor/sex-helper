<script lang="ts">
  export let snapchatUsername: string = "your_snapchat_username";
</script>

<a
  href={`https://www.snapchat.com/add/${snapchatUsername}`}
  target="_blank"
  rel="noopener noreferrer"
  class="snapchat-btn group"
...
>
  ...
  <span class="tooltip">Add us on Snapchat!</span>
</a>

<style lang="postcss">
  .snapchat-btn {
    @apply relative inline-flex items-center justify-center;
    @apply text-white/80 hover:text-yellow-400;
  ...
  /* Add a little bounce animation on hover */
  .snapchat-btn:hover .snapchat-icon {
